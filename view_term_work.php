...
<body>
      ...
      <form method="POST" action= "#" >
        ...
        <div class="container">
            <div class="form-group" style="width: 35%; float: left; margin-right: 70px">
              ...
              <option value="" selected hidden disabled>Select Scheme</option>
                <option>R-16</option>
                <option>R-19</option>
              </select>
            </div>
 ...
 <?php
    ...
    <td><?php echo $row['student_id'] ?></td>
      ...
      #$percentage = ((($arr['m1']+$arr['m2']+$arr['m3']+$arr['m4'])/($lectures_taken['m1']+$lectures_taken['m2']+$lectures_taken['m3']+$lectures_taken['m4']))*100);
      // echo $percentage;
      ...
      <script type="text/javascript">
          ...
          <td id="total"></td>
            ...
            final=grandtotal;
            document.getElementById("grand").innerHTML = final;
            document.getElementById("term").innerHTML = result;
          //   return grandtotal;
          // }
          </script>
        <td id= "term"> </td> 
